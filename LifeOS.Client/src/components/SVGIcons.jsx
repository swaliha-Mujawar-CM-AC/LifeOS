...
export const SVGIcons = {
  ...
  Expenses: () => (
    <span style={{ fontSize: '18px', fontWeight: 500, lineHeight: 1, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '18px', height: '18px', transform: 'scale(1.1, 1.25)' }}>₹</span>
  ),
  Decisions: () => (
  ...
  Leaf: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 21 C12 18 9 14 4 11 C2 10 1 12 3 16 C5 20 8 21 12 21 Z" fill="currentColor" />
      <path d="M12 21 C12 17 15 12 21 10 C23 9 24 11 22 15 C20 19 16 21 12 21 Z" fill="currentColor" />
      <path d="M12 21 L8 14 M9 17 L6 15 M10 14 L8 12" stroke="#1a3525" strokeWidth="1" strokeLinecap="round" />
      <path d="M12 21 L17 13 M15 17 L18 15 M14 14 L17 12" stroke="#1a3525" strokeWidth="1" strokeLinecap="round" />
    </svg>
  ),
  Flame: () => (
  ...
  GymIcon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18.5 5.5 3 3"/><path d="m2.5 15.5 3 3"/><path d="m16 4.5L19.5 8"/><path d="m4.5 16 3.5 3.5"/></svg>
  ),
  Logout: () => (
  ...
  Shield: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>
  )
};
